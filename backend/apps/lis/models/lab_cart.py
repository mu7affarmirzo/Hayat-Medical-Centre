...
class OrderedLabResearchModel(models.Model):
    ...
    validated_by = models.ForeignKey(Account, related_name="validated_cart_lab_research", on_delete=models.SET_NULL, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey(Account, on_delete=models.SET_NULL, null=True, verbose_name='registered_by')

    modified_by = models.ForeignKey(Account, related_name="modf_cart_lab_research", on_delete=models.SET_NULL, null=True)
