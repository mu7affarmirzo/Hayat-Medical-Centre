...
def register_income(request):
    ...
    return render(request, 'v2/../../templates/main_point/test.html', {'form': form, 'formset': formset})
...
def register_income_dynamic(request):
    ...
    return render(request, 'v2/../../templates/main_point/test_dynamic.html', context)
