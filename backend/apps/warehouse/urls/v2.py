...
urlpatterns = [
    ...
    path('main-point/income/create/test', income.income_create_view, name='mp-income-create-test'),
    ...
    path('main-point/income/', main_point_income.search_items, name='mp-items'),
