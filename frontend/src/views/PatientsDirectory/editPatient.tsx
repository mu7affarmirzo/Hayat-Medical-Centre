...
const EditPatient = () => {
    ...
    const post_patient = () => {
        axios
            .put("https://back.dev-hayat.uz/api/v1/organizations/patients/", state, headers)
            .then((res) => {
                if (res.status === 201) {
    ...
    React.useEffect(() => {
        axios.get(`https://back.dev-hayat.uz/api/v1/organizations/patients/${params.id}`, headers)
            .then(response => {
